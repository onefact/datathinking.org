...
const DESCRIPTION = 'Open source courses for understanding AI, data, startups, and business.';
const MARKDOC = `
...
export default function MyApp(props) {
  ...
  const isDocs = props.router.asPath.startsWith('/university-of-tartu') || props.router.asPath.startsWith('/about') || props.router.asPath.startsWith('/sales-startups-business');
    ...
    <div className={`${isLandingPage ? 'page--landing' : ''}`}>
      <Head>
        ...
        <meta
          ...
          content="https://markdoc.dev/images/share.png"
        />
        <script defer data-domain="datathinking.org" src="https://plausible.io/js/script.js"></script>
      </Head>
